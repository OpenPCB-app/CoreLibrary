...
import type { FootprintRenderModel, SymbolRenderModel } from "../render";
import {
  parseKicadFootprint,
  parseKicadSymbolLib,
...
import { extractPackageCode } from "../parsers/heuristics";
import { classifyModel3DLinks } from "../parsers/kicad-model-linker";
